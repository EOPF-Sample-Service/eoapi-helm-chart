...
UPDATE collections set partition_trunc='month' WHERE id='sentinel-1-l1-slc-zarr3';
UPDATE collections set partition_trunc='month' WHERE id='sentinel-1-l1-grd-zarr3';
UPDATE collections set partition_trunc='month' WHERE id='sentinel-1-l2-ocn-zarr3';
